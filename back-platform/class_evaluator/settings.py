"""
Django settings for class_evaluator project.
...
ROOT_URLCONF = 'class_evaluator.urls'
...
WSGI_APPLICATION = 'class_evaluator.wsgi.application'
...
# cors authorization
CORS_ALLOWED_ORIGINS = ['http://localhost:5173', 'tesis-0xfh.onrender.com']
